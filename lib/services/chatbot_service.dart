...
class ChatbotService {
  ...
  static Future<Map<String, dynamic>> sendMessage({
    ...
    try {
      ...
      debugPrint('📡 [ChatbotService] Send message status: ${response.statusCode}');
  ...
  static Future<List<Map<String, dynamic>>> getSessions() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${Api.baseUrl}/chatbot/sessions'),
        headers: headers,
      ).timeout(
  ...
  static Future<Map<String, dynamic>> getMessages(String sessionId) async {
    try {
      debugPrint('🔍 [ChatbotService] Fetching messages for session $sessionId...');
  ...
  static Future<bool> deleteSession(String sessionId) async {
    try {
      ...
      debugPrint('📡 [ChatbotService] Delete session status: ${response.statusCode}');
